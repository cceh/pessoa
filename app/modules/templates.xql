...
declare function templates:getErrorPage($node as node(), $model as map(*)) {
    ...
    else <span><p>An error has been generated by the application. </p>
        <p>You can help us to improve the application if you report the error to <script type='text/javascript'>mail('pessoa-info','uni-koeln.de')</script>. </p>
        <p> Go back to  <a class='pLink' href='{$config:app-root}/index'>Home</a>.</p></span>
};