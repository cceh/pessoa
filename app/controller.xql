                ...
                <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
                    ...
                    return
                        ...
                        if(local:login()) then
                            ...
                            return
                                transform:transform((collection("/db/apps/pessoa/data/doc"), collection("/db/apps/pessoa/data/pub"))//tei:TEI, doc("/db/apps/pessoa/xslt/events.xsl"), <parameters><param name="language" value="{$language}"/><param name="basepath" value="{$exist:root}"></param></parameters>)
